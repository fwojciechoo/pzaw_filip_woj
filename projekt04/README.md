# O stronie
    Strona o hotelach.Jeśli użytkownik nie jest zalogowany moze tylko przegladac opinie. Zwykły użytkownik, czyli taki, który nie ma uprawnien admina moż dodawać nowe hotele 
